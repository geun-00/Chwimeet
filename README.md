...
특히 2-stage RAG에서 핵심이 되는 **두 개 이상의 LLM을 동시에 사용하는 구조**를  
설정 중심으로 구성할 수 있어, 모델을 교체하거나 추가하더라도 비즈니스 로직에 미치는 영향을 최소화할 수 있었습니다.  
...
무엇보다 Spring 기반 프로젝트였기 때문에  
AI 기능을 기존 서비스 구조 안에 자연스럽게 녹일 수 있었고,  
...
- **검색 정확도 향상**
  ...
  - 예: 3개를 가져왔는데 2개는 적합하지만 1개는 키워드만 겹치는 무관한 게시글
